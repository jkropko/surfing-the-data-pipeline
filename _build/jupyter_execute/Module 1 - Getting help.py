...
* [Method 1: Reading and Understanding Python Errors](#error)
* [Method 2: Using the Built-in Python Documentation](#doc)
  * [Using a Console Window in JupyterLab](#labwindow)
  * [How to Call Up and Read a Docstring](#docstring)
* [Method 3: Using Google and Other Search Engines](#google)
* [How to Avoid Toxicity in Online Communities](#online)
* [Method 4: Stack Overflow](#stack)
  * [How Stack Overflow Works](#soworks)
  * [Asking a Question on Stack Overflow](#ask)
* [Method 5: Python Slack](#slack)
* [Method 6: Live Chats With Python Users on Freenode](#chat)
* [Method 7: Python Mailing Lists and Newsgroups](#mailing)
...
## <a name="error"></a>Method 1: Reading and Understanding Python Errors
...
## <a name="doc"></a> Method 2: Using the Built-in Python Documentation 
...
## <a name="google"></a> Method 3: Using Google and Other Search Engines
...
## <a name="stack"></a> Method 4: Stack Overflow
...
## <a name="slack"></a> Method 5: Python Slack
...
## <a name="chat"></a> Method 6: Live Chats With Python Users on Freenode
...
## <a name="mailing"></a> Method 7: Python Mailing Lists and Newsgroups
